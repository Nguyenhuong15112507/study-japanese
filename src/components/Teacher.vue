<template>
    <div class="page-body">
        <div class="side-bar">
            <div class="anouncement">
                ...
                <div class="announce-list">
                    ...
                    <div class="announce-item">
                        ...
                        <p class="anounce-para">I've just uploaded new lesson. Please learn and do your homework. Deadline
                            is this weekend.</p>
            ...
            <div class="anouncement">
                ...
                <div class="announce-list">
                    <button class="new-btn" id="creat-new-result-btn" style="margin: 10px;">Create</button>
                    <button class="new-btn cancel-btn delete-btn" id="delete-result-btn"
                        style="margin-left: 0;">Delete</button>
                    <div class="announce-item">
                        <h4 class="anounce-theme">New lesson was uploaded.</h4>
                        <p class="anounce-para">I've just uploaded new lesson. Please learn and do your homework. Deadline
                            is this weekend.</p>
        ...
        <div class="page-container">
            <div class="content-input">
                ...
                <div class="content-input-header">
                    <button class="new-btn" id="creat-new-lesson-btn" @click="handleOpenPopup()">Create</button>
                ...
                <div class="list-content-item lesson-content-list">
                    ...
                    <div v-for="(item, index) in lessonContenlist" :key="index" class="lession-content-overview">
                        ...
                        <p class="overview-para">{{ item.Gramform }}</p>
                        <ul class="show-detail-and-practice">
                            <li class="show-detail"><a href="" @click="handleShowDetail(item.id)">Show detail</a></li>
                            <li class="practice-example"><a href="">Practice</a></li>
                        </ul>
                    </div>
                ...
                <div class="new-input daily">
                    ...
                    <div class="new-form daily-create">
                        ...
                        <div class="btn-container">
                            <button class="new-btn submit-btn" id="submit-daily-btn"
                                @click="appendKanjiContent()">Submit</button>
                ...
                <div class="list-content-item daily-content-list">
                    <div v-for="(item, index) in kanjiContentList" :key="index" class="daily-content-overview">
                        ...
                        <div class="show-detail">
                            <a href="" class="show-detail" @click="handleShowKanjiDetail()">Show detail</a>
                        </div>
                    </div>
    ...
    <div v-if="isDisplayLessonCreate" :class="['anouncement-create', { 'isVisible': isDisplayLessonCreate }]">
        <div class="new-input lesson">
            ...
            <div class="new-form lesson-create">
                ...
                <div class="input-item">
                    ...
                    <textarea class="textareacss" name="lessonContent" id="lessonContent1"
                        v-model="lessonContentForm"></textarea>
                </div>
                <div class="input-item">
                    ...
                    <textarea class="textareacss" name="lessonContent" id="lessonContent2"
                        v-model="lessonContentDefine"></textarea>
                </div>
                <div class="input-item">
            ...
            <div class="btn-container">
                <button class="new-btn submit-btn" id="submit-lesson-btn" @click="appendLessonContent()">Submit</button>
                <button class="new-btn cancel-btn" id="cancel-lesson-btn" @click="handleClosePopup()">Cancel</button>
            </div>
        </div>
    </div>
    <!-- Announce create -->
    <div v-if="isDisplayAnnounceCreate" :class="['anouncement-create', { 'isVisible': isDisplayAnnounceCreate }]">
        <div class="new-input announce">
            ...
            <div class="btn-container">
                <button class="new-btn submit-btn" id="submit-createdanounce-btn"
                    @click="appendAnnounceContent()">Submit</button>
                <button class="new-btn cancel-btn" id="cancel-createdanounce-btn"
                    @click="handleOnClickbtn()">Cancel</button>
            </div>
        </div>
    </div>
...
const lessonContenlist = ref(userStudentJapaneseStore.lesson !== null ? userStudentJapaneseStore.lesson : [])
...
const announceContenlist = ref(userStudentJapaneseStore.announce !== null ? userStudentJapaneseStore.announce : [])
const announceName = ref('')
const announceContent = ref('')
const annouceDate = ref('')
const selected = ref(false)

const kanjiContentList = ref(userStudentJapaneseStore.kanji !== null ? userStudentJapaneseStore.kanji : [])
...
const appendLessonContent = () => {
    const data = {}
    if (lessonName.value == "" && lessonContentForm.value == "" && lessonContentDefine.value == "" && lessonContentExample1.value == "" && lessonDate.value == "" && homework.value == "") return
    ...
    lessonContenlist.value.push(data)
    ...
    userStudentJapaneseStore.appendGrammarId(r)
...
const appendKanjiContent = () => {
    ...
    kanjiContentList.value.push(kanjiData)
...
const appendAnnounceContent = () => {
    const announceData = {}
    if (announceName.value == "" && announceContent.value == "" && annouceDate.value == "") return
    ...
    announceContenlist.value = announceContenlist.value.map((item, index) => { return { ...item, index } })// them key 'index' vao object announceData
...
const handleChangeCheckbox = (row) => {
    if (multiSelection.value.includes(row.index)) {
        multiSelection.value = multiSelection.value.filter(item => item != row.index)
    } else {
...
const removeAnnounce = () => {
    ...
    multiSelection.value.forEach((itemSelect, index) => {
        announceContenlist.value = announceContenlist.value.filter(item => itemSelect != item.index)
    })
    // 
}
