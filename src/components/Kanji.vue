        ...
        <div class="question-group-list">
          <div class="question-group-item">
            ...
            <div class="input-item" style="display: flex; align-items: center; width: 500px;">
              ...
              <input :disabled="isDisabled" class="form-control" type="text" name="lessonName"
                     v-model="kanjinewForm.title" id="announceName"
            ...
            <div class="input-item" style="display: flex; align-items: center; width: 500px; margin-top: 10px">
              ...
              <input :disabled="isDisabled" class="form-control" v-model="kanjinewForm.description" type="text"
                     name="lessonName" id="announceName" style="margin-left: 37px"/>
            </div>
            <div class="vocabulary-list">
              <div class="button-container">
                ...
                <button @click="handleChangeKanjiFlashcard(kanjinewForm.id)" class="btn btn-info"
                        id="creat-new-result-btn" style="margin: 10px">
                  Learn
                </button>
